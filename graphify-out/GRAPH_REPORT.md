...
| src/data_normalization/03_land_price.py | .codemapper_cache.json | 0 |  |  |  |

## Communities

- Community **17**: 33 nodes — representative: `data.md` (docs/data.md)
- Community **38**: 24 nodes — representative: `app.js` (src/frontend/app.js)
- Community **5**: 22 nodes — representative: `market_context` (artifacts/market-viability.json)
- Community **45**: 21 nodes — representative: `mtimes` (.codemapper_cache.json)
...
- Community **98**: 18 nodes — representative: `api.py` (src/model/api.py)
- Community **10**: 18 nodes — representative: `market-viability.md` (artifacts/market-viability.md)

## Quality Signals

Dead code / dead files: **16** nodes flagged
